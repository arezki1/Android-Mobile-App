...
public class Count_four extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_count_four);
        Button btnCount1=findViewById(R.id.four3);
        Button btnCount2=findViewById(R.id.four4);
        Button btnCount3=findViewById(R.id.four5);
