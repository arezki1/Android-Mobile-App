...
public class Count_five extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_count_five);
        Button btnCount1=findViewById(R.id.five1);
        Button btnCount2=findViewById(R.id.five5);
        Button btnCount3=findViewById(R.id.five3);
