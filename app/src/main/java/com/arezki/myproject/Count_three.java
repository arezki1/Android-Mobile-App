...
public class Count_three extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_count_three);

        Button btnCount1=findViewById(R.id.three1);
        Button btnCount2=findViewById(R.id.three2);
        Button btnCount3=findViewById(R.id.three3);
