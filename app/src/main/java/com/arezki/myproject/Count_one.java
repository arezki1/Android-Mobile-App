...
public class Count_one extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_count_one);

        Button btnCount1=findViewById(R.id.one6);
        Button btnCount2=findViewById(R.id.one1);
        Button btnCount3=findViewById(R.id.one7);
